...
def build_report(context: dict[str, object]) -> str:
    return f"""# Voting-bloc graph analysis: Eurovision 1957–2021 dataset
...
Left alone these split e.g. the UK into two nodes carrying {context['uk_note']}.
...
| --- | --- | --- | --- | --- | --- |
| `full` | 2004–2021 | all (combined + jury + televote) | {context['full_nodes']} | {context['full_edges']} | {context['full_density']:.2f} |
| `jury` | 2016–2021 | `{JURY_COL}` | {context['jury_nodes']} | {context['jury_edges']} | {context['jury_density']:.2f} |
| `televote` | 2016–2021 | `{TELEVOTE_COL}` | {context['tele_nodes']} | {context['tele_edges']} | {context['tele_density']:.2f} |
...
def main() -> None:
    ...
    context: dict[str, object] = {
        "uk_note": "220 and 93 vote records respectively in 2004–2021",
        ...
        "mean_verdict": (
            ...
            "graphs cover the same five contests and the same countries."
        ),
    }
